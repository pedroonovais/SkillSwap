        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditValue = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    FromUserId = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    ToUserId = table.Column<Guid>(type: "RAW(16)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Skills_SkillId",
                        column: x => x.SkillId,
